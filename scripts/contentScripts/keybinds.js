...
const handleGlobalKeyEvents = (e) => {
  storage.getHorseConfig((horseConfig) => {
    ...
    if (testsBeforeKeybinds(e, horseConfig)) return;
    if (
      e.code === horseConfig["keybinds"]["horsePageAll"] &&
      window.location.href != "https://v2.horsereality.com/horses/stall/all"
    ) {
      window.open("https://v2.horsereality.com/horses/stall/all", "_self");
    } else if (
      e.code === horseConfig["keybinds"]["marketHomePage"] &&
      window.location.href != "https://v2.horsereality.com/market"
    ) {
      window.open("https://v2.horsereality.com/market", "_self");
    } else if (
      e.code === horseConfig["keybinds"]["bankPage"] &&
      window.location.href != "https://v2.horsereality.com/bank"
    ) {
      window.open("https://v2.horsereality.com/bank", "_self");
    } else if (
      e.code === horseConfig["keybinds"]["laboratoryPage"] &&
      window.location.href != "https://v2.horsereality.com/laboratory"
    ) {
      window.open("https://v2.horsereality.com/laboratory", "_self");
    } else if (
      e.code === horseConfig["keybinds"]["ridingSchoolPage"] &&
      window.location.href != "https://v2.horsereality.com/ridingschool"
    ) {
      window.open("https://v2.horsereality.com/ridingschool", "_self");
    } else if (
      e.code === horseConfig["keybinds"]["vetarinaryPage"] &&
      window.location.href != "https://v2.horsereality.com/veterinary"
    ) {
      window.open("https://v2.horsereality.com/veterinary", "_self");
    } else if (
      e.code === horseConfig["keybinds"]["currencyExchangePage"] &&
      window.location.href != "https://www.horsereality.com/currency-exchange"
    ) {
      window.open("https://www.horsereality.com/currency-exchange", "_self");
    } else if (
      e.code === horseConfig["keybinds"]["cityPage"] &&
      window.location.href != "https://v2.horsereality.com/city"
    ) {
      window.open("https://v2.horsereality.com/city", "_self");
    } else if (
      e.code === horseConfig["keybinds"]["wikiPage"] &&
      window.location.href != "https://horsereality.wiki"
    ) {
      window.open("https://horsereality.wiki", "_self");
    } else if (
      e.code === horseConfig["keybinds"]["profilePage"] &&
      window.location.href !=
        document
          .getElementsByClassName("user-nav")[0]
